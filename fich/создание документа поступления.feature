...
срздание документа поступления товара
чтобы поставить товао научет
Контекст:
Дано Я открыл новый сеанс TestClient или подключил уже существующий

Сценарий: создание документа поступление товаров
//Создание документа поступления для гит 3
// добавила вторую строку комметария
...
Сценарий: Проврка наличия в справочнике номенклатуры торт
